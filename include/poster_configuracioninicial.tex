...
% Si se debe establecer un tamaño de página concreto elimina el comentario de abajo
%\geometry{paperwidth=70cm,paperheight=100cm}
% Si se utiliza una medida personalizada es posible que haya que modificar otros
% parámetros para ajustar la cabecera y pie de página.
...
% GRAFICOS 
%%%%%%%%%%%%%%%%%%%%%%%%
\usetikzlibrary{decorations.text,spy}
