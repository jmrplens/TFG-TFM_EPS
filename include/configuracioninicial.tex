...
\usepackage{pgfplots}
\pgfplotsset{compat=1.15} % Retrocompatibilidad
...
% COMANDOS AÑADIDOS
%%%%%%%%%%%%%%%%%%%%%%%%
% Para mostrar la fecha actual con \Hoy
\newcommand{\Hoy}{\today}
...
% CÓDIGO
%%%%%%%%%%%%%%%%%%%%%%%%
% Paquete para mostrar codigo de matlab. En caja y lineas numeradas
...
% Para incluir páginas de un PDF
\usepackage{pdfpages}
