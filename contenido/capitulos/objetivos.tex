...
\begin{codigosimple}{latex}{Sintaxis: Estructura básica de una tabla}
...
\begin{codigosimple}{latex}{Sintaxis: Tabla simple}
\begin{table}[H]
  \centering
  \begin{tabular}{lcc}
           & Columna A & Columna B \\
...
\begin{codigosimple}{latex}{Sintaxis: recomendado}
\begin{table}[H]
  \centering
...
\begin{codigosimple}{latex}{Sintaxis: Tabla con columnas de ancho fijo}
...
\begin{codigosimple}{latex}{Sintaxis: Tabla con multicolumna y multifila}
...
\begin{codigosimple}{latex}{Sintaxis: Tabla con colores alternados}
...
\begin{codigosimple}{latex}{Sintaxis: Forzar posición de tablas}
...
\begin{codigosimple}{latex}{Sintaxis: Tablas con notas al pie}
...
\begin{codigosimple}{latex}{Sintaxis: Tabla con celdas de colores personalizados}
% Celda coloreada
...
\begin{codigosimple}{latex}{Sintaxis: Tabla de ancho completo}
...
\begin{codigosimple}{latex}{Sintaxis: Resumen de comandos para tablas}
% Estructura básica
\begin{table}[H]
  \centering
  \caption{Título}
