...
\begin{codigosimple}{latex}{Sintaxis: Figura simple}
...
\begin{codigosimple}{latex}{Sintaxis: Opciones de includegraphics}
...
\begin{codigosimple}{latex}{Sintaxis: Subfiguras}
\begin{figure}[H]
  \centering
...
\begin{codigosimple}{latex}{Sintaxis: Subfiguras verticales}
\begin{figure}[H]
  \centering
...
\begin{codigosimple}{latex}{Sintaxis: Múltiples imágenes en cuadrícula}
\begin{figure}[H]
  \centering
  \begin{tabular}{ccc}
...
\begin{codigosimple}{latex}{Sintaxis: Figuras a ancho completo}
...
\begin{codigosimple}{latex}{Sintaxis: Organización de archivos}
recursos/
├── imagenes/
...
\begin{codigosimple}{latex}{Sintaxis: Resumen de comandos para figuras}
% Figura básica
\begin{figure}[H]
  \centering
