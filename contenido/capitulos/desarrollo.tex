...
\begin{codigosimple}{latex}{Sintaxis: Python}
\begin{pythoncode}
  ... código Python ...
\end{pythoncode}
\end{codigosimple}
...
\begin{codigosimple}{latex}{Sintaxis: Sin numeración de líneas}
\begin{pythoncodeNN}
  ... código sin números ...
\end{pythoncodeNN}
\end{codigosimple}
...
\begin{codigosimple}{latex}{Sintaxis: JavaScript}
\begin{jscode}
  ... código JavaScript ...
\end{jscode}
\end{codigosimple}
...
\begin{codigosimple}{latex}{Sintaxis: Java}
\begin{javacode}
  ... código Java ...
\end{javacode}
\end{codigosimple}
...
\begin{codigosimple}{latex}{Sintaxis: Python Dark}
...
\begin{codigosimple}{latex}{Sintaxis: JavaScript Dark}
\begin{jscodeDark}
  ... código JavaScript ...
\end{jscodeDark}
\end{codigosimple}
...
\begin{codigosimple}{latex}{Sintaxis: HTML}
\begin{htmlcode}
  ... código HTML ...
\end{htmlcode}
\end{codigosimple}
...
\begin{codigosimple}{latex}{Sintaxis: CSS}
\begin{csscode}
  ... código CSS ...
\end{csscode}
\end{codigosimple}
...
\begin{codigosimple}{latex}{Sintaxis: SQL}
\begin{sqlcode}
  ... consulta SQL ...
\end{sqlcode}
\end{codigosimple}
...
\begin{codigosimple}{latex}{Sintaxis: C++}
\begin{cppcode}
  ... código C++ ...
\end{cppcode}
\end{codigosimple}
...
\begin{cppcode}
// Cabeceras necesarias: <iostream>, <vector> y <algorithm>
...
\begin{codigosimple}{latex}{Sintaxis: Rust}
\begin{rustcode}
  ... código Rust ...
\end{rustcode}
\end{codigosimple}
...
\begin{codigosimple}{latex}{Sintaxis: Go}
\begin{gocode}
  ... código Go ...
\end{gocode}
\end{codigosimple}
...
\begin{codigosimple}{latex}{Sintaxis: PHP}
\begin{phpcode}
  ... código PHP ...
\end{phpcode}
\end{codigosimple}
...
\begin{codigosimple}{latex}{Sintaxis: Ruby}
\begin{rubycode}
  ... código Ruby ...
\end{rubycode}
\end{codigosimple}
...
\begin{codigosimple}{latex}{Sintaxis: Docker}
\begin{dockercode}
  ... Dockerfile ...
\end{dockercode}
\end{codigosimple}
...
\begin{codigosimple}{latex}{Sintaxis: Entorno Genérico}
...
\begin{codigosimple}{latex}{Sintaxis: Versión Dark del Genérico}
...
\begin{codigosimple}{latex}{Sintaxis: Código Simple sin Numeración}
