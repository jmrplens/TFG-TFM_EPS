...
\begin{itemize}
  \item Esta demostración confirma que múltiples páginas landscape funcionan correctamente.
  \item Los números de página se incrementan normalmente.
  \item Los encabezados muestran la sección actual.
  \item Los pies de página mantienen su formato.
\end{itemize}
